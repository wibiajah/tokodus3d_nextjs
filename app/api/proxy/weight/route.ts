// app/api/proxy/weight/route.ts
// Server-side proxy untuk Laravel /api/3d/CalculateWeight
...
export async function POST(req: NextRequest) {
  try {
    ...
    const res = await fetch(`${LARAVEL}/api/3d/CalculateWeight`, {
      method: "POST",
      headers: {
    ...
    console.error("[proxy/weight] error:", err);
